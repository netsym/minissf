...
#ifndef QUENET
  void ParseSeed(const char* f, unsigned short int s[]);
#endif
  void ResetFilePointer();
  void ParseError(const char* e, string g);
  void ParseError(string e, const char* g);
  void ParseError(const char* e, const char* g);
...
private:
  ...
  void ParseIntField(const char* f, int& v);
  void ParseIntField(int& v);
  void ParseDoubleField(const char* f, double& v);
  void ParseDoubleField(const double& v);
  void ParseStringField(const char* f);
  void ParseStringField(const char* f, string& s);
  int FileSize();
