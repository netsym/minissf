...
Parse::Parse(const char* f) : delimiters(6), output_formats(2) {
...
void Parse::ParseError(const char* e, string g) {
...
void Parse::ParseError(const char* e, const char *g) {
...
void Parse::ParseError(string e, const char *g) {
...
void Parse::ParseIntField(const char* f, int &v) {
...
void Parse::ParseDoubleField(const char* f, double &v) {
...
void Parse::ParseStringField(const char* f) {
...
void Parse::ParseStringField(const char* f, string& s) {
...
#ifndef QUENET
void Parse::ParseSeed(const char* f, unsigned short int seed[]) {
